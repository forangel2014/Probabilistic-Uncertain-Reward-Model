...
train_files=/cpfs/user/sunwangtao/dataset/uncertain/purm_preference_data-valid
valid_files=/cpfs/user/sunwangtao/dataset/uncertain/purm_preference_data-test
cp ./run_btrm.sh ${exp_dir}
