...
class PPORayActorGroup:
    ...
    def async_fit_actor_model(
        ...
        Args:
            ...
            custom_reward_model: custom reward model, not only a NN model.
        ...
        print(f"enter into async_fit_actor_model, remote_rm_urls: {remote_rm_urls}, reward_fn: {reward_fn}")
